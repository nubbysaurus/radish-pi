/******************************************************************************
i2ctest_radish.cpp
Raspberry Pi I2C interface demo for Radish'n'bots.
based on code by Byron Jacquot @ SparkFun Electronics>
https://github.com/sparkfun/Pi_Wedge
  last modified : 2/10/2020
   ) 0 o .

A brief demonstration of the Raspberry Pi I2C interface, using an ADS1115 board.
...
This file interfaces with an ADS1115 ADC board:
...
>  g++ i2ctest_radish.cpp -lwiringPi
...
This code is beerware; if you see any SparkFun employee at the
...
int main()
{
   ...
   // The ADS1115 is addressable to address 0x48.   
   //
